...
@foreach($nutritionfact as $obj)

<div class="item showService col-md-4" style="height:50vh" >
  <a href="<?php echo URL::to('/')?>/healthfact/{{$obj->id}}" style=" position:relative;">
        ...
        display:block;">
                                    <div class="overlayContainer">
                                        ...
                                        <img src="/storage/nutrationfact/{{$obj->image}}"  alt="no current image " width="100%" height="236" style="height:auto;
        max-width:100%;
        border:none;
        display:block;">
